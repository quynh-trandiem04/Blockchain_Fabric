// my-ecommerce-chaincode/model.go
...
type Order struct {
	...
	// --- CẤP ĐỘ TỔ CHỨC (MSP) ---
	SellerID  string `json:"sellerID"`  // Lưu MSP của Seller (VD: "SellerOrgMSP")
	ShipperID string `json:"shipperID"` // Lưu MSP của Shipper (VD: "ShipperOrgMSP")

	// --- CẤP ĐỘ CÔNG TY/CỬA HÀNG (Attribute) ---
	// Dùng để phân quyền chi tiết (ABAC)
	SellerCompanyID  string `json:"sellerCompanyID"`  // VD: "Shop_ABC", "Store_XYZ"
	ShipperCompanyID string `json:"shipperCompanyID"` // VD: "GHN", "VTP", "J&T"
